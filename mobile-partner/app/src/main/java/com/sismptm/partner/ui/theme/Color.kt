...
val PrimaryAccent = Color(0xFF2563EB) // Vibrant blue - Primary buttons
...
// Background Colors
val Background = Color(0xFF121826) // General background
val BackgroundElevated = Color(0xFF1A2332) // Slightly elevated background
val Surface = Color(0xFF121826) // Base surface

// Card/Container Colors
val CardBackground = Color(0xFF1C2533) // Container/card background
val CardBackgroundHover = Color(0xFF232D3D) // Card hover state
val InputBackground = Color(0xFF1C2533) // Input and text fields
...
val BorderSubtle = Color(0xFF374151) // Subtle borders and dividers
val BorderFocus = Color(0xFF2563EB) // Focus state borders
...
val OnlineIndicator = Color(0xFF10B981) // Online status indicator
val OfflineIndicator = Color(0xFF6B7280) // Offline status indicator
